...
/** Shared styles for card-style clickable list rows in the side panel. */
const listRowButtonClass = cn(
  cardSurfaceClass,
  'w-full cursor-pointer text-left hover:bg-surface-3 disabled:pointer-events-none disabled:opacity-50',
);
  ...
  'inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*=\'size-\'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]',
  {
    variants: {
      variant: {
        ...
        outline:
          'border bg-background shadow-xs hover:bg-surface-2 hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-surface-2',
...
export { Button, buttonVariants, listRowButtonClass };
